        ...
        foreach($data as $rows => $row)
        {
            ...
            echo "<tr>
                ...
                <td>
                    <center>
                        <div class='btn-group'>
                            <a href='index.php?section=usuario&action=listado&edit=".$row["id_usuario"]."'><button type='button' title='Editar Usuario' class='btn btn-default'><i class='fa fa-edit'></i></button>
                            <button type='button' title='Eliminar Usuario' class='btn btn-default' data-toggle='modal' data-target='#modal-info-eliminar' onclick='idDel(".$row["id_usuario"].")'><i class='fa fa-trash-o'></i></button>
                        </div>
                    </center>
                </td>
            </tr>";
