<?php
//importamos el archivo con la funcion update_futbolista
require_once("database_details.php");

//obtenemos el id del futbolista a modificar
$id = isset( $_GET['id'] ) ? $_GET['id'] : "";

//verificamos que se haya enviado informacion
if(isset($_POST["enviar"]))
{
    //enviamos los datos a la funcion de update_futbolista
    update_futbolista($_POST["oldId"],$_POST["newId"],$_POST["nombre"],$_POST["posicion"],$_POST["carrera"],$_POST["email"]);
            ...
            <div class="large-9 columns">
                ...
                <div class="section-container tabs" data-section>
                    <section class="section">
                        <!--Formulario para modificar la informacion del futbolista-->
                        <?php
                        //obtenemos la informacion del futbolista
                        $data = info_futbolista($id);
                        ?>
                ...
                <a href="futbolistas.php" class="button">Regresar</a>         
                
            </div>
        </div>
        
        <script>
            //funcion para preguntar si en verdad desea modificar la informacion del futbolista 
            function verificar(e)
            {
                //le preguntamos si en verdad quiere modificarlo
                var opc = confirm("Esta Seguro De Modificar La Informacion Del Futbolista");
