<?php
//importamos el archivo con la funcion add_futbolista
require_once("database_details.php");

//verificamos que se haya enviado informacion
if(isset($_POST["enviar"]))
{
    //enviamos los datos a la funcion add_futbolista
    add_futbolista($_POST["id"],$_POST["nombre"],$_POST["posicion"],$_POST["carrera"],$_POST["email"]);
    //redireccionamos al listado de futbolistas
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="large-9 columns">
                <h3>Registro de Futbolista</h3>

                <div class="section-container tabs" data-section>
                    <section class="section">
                        <!--Formulario para registrar un nuevo futbolista-->
