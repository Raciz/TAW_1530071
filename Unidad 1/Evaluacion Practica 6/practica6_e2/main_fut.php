<?php
  ...
  $user = mostrarFut(); //ejecutar la funcion que trae todos los registros de la tabla futbolistas
  $total_users = count(mostrarFut()); //cuenta el total de registros devuelto por la consulta
?>
<!doctype html>
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="large-9 columns">
        <h3>Futbolistas</h3>
          <p><a href="agregarFut.php" class="button radius tiny secondary">Agregar nuevo</a></p>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="./modificarFut.php?id=<?php echo $users[0]; ?>" class="button radius tiny secondary">Modificar</a>
    ...
    <script type="text/javascript">
      function confirmar(id){
        ...
        if(r){
           window.location.href='eliminarFut.php?id='+id; //se redirecciona al archivo de eliminar.php
        }else{
          window.location.href='main_fut.php'; 
        }
      }
    </script>
